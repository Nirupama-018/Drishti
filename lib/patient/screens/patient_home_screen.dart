...
class _PatientHomeScreenState extends State<PatientHomeScreen> {
  ...
  void initState() {
    ...
    // Later Member 1's AI will provide this.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Drishti'), centerTitle: false),
                ...
                children: [
                  Expanded(
                    child: _buildSmallActionCard(
                      ...
                      title: 'My Progress',
                      onTap: () {
                        Navigator.pushNamed(context, '/patient/progress');
                      },
                    ),
                  ),
                  ...
                  Expanded(
                    child: _buildSmallActionCard(
                      ...
                      title: 'Reminders',
                      onTap: () {
                        Navigator.pushNamed(context, '/patient/reminders');
                      },
                    ),
                  ),
                ],
